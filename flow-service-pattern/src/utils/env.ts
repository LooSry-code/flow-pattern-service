...
export const CLOUDINARY_API_SECRET: string = process.env.CLOUDINARY_API_SECRET || 'xA9B5OGl_T5D_XfgXqG9GSuHIU8';
export const CLOUDINARY_CLOUD_NAME: string = process.env.CLOUDINARY_CLOUD_NAME || 'dfbyugdhl';
